<script lang="ts">
	...
	import { funcaoUrlCdnDaImagem } from '$lib/funcoes/funcaoUrlCdnDaImagem';
	...
	let {
		...
		loading = 'lazy',
		fetchpriority = 'auto',
		isIntersecting = false, //ADICIONADO POR MIM
		...rest
	}: {
		class?: string;
		alt?: string;
		...
		isIntersecting?: boolean; //ADICIONADO POR MIM
	...
	// let isIntersecting = $state(false); // REMOVIDO POR MIM
...
<div
	...
	style="aspect-ratio: {aspectWidth}/{aspectHeight}; {height !== 'auto'
		? `height: ${height}px;`
